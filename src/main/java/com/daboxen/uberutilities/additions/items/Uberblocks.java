...
public class Uberblocks {
	public static BlockEntry<Block> NEUTRONIUM_MACHINE_CASING = createCasing("neutronium_casing");
	
	public static BlockEntry<Block> createCasing(String name) {
		return createCasing(name, 2);
	}
	
	public static BlockEntry<Block> createCasing(String name, int tier) {
